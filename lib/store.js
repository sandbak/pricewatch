  ...
  await db.query(
    `
      ...
      DO UPDATE SET
        ...
        alert_sent = COALESCE(EXCLUDED.alert_sent, product_state.alert_sent),
        promotion = COALESCE(EXCLUDED.promotion, product_state.promotion),
        updated_at = NOW()
    `,
    [
      productDbId,
      ...
      updates.alertSent ?? null,
      updates.promotion ? JSON.stringify(updates.promotion) : null,
    ]
  );
}
